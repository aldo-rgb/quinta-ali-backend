...
// Consultas en el momento de Rino (disponibilidad, apartar fechas, reportes de clientes): también firmadas sobre el cuerpo crudo
app.use('/api/rino', require('./routes/rinoConsultas'));
